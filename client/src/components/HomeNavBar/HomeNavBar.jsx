                    ...
                    <ul className="navbar-nav d-flex flex-row" >
                        ...
                        {!!userId && <li className="nav-item me-3 me-lg-0">
                            <a onClick={() => {
                                ...
                                <Link to="/" className={styles.navbarbuttons}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style={{ margin: "10px" }} className="bi bi-escape" viewBox="0 0 16 16">
